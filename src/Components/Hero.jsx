...
const Hero = () => {
  const [text] = useTypewriter(
    {
      words: ['React Developer', 'Samed Shukurov', 'Programmer'],
      loop: {},
      typeSpeed: 150,
      deleteSpeed: 60,
    }
  ...
  return (
    <section id="hero">
      <div className="hero-container">
        <article>
          <div>
            <h1 className="hero-article-heading">Hi <i className="fa-light fa-hand-wave emoji"></i></h1>
          ...
          <div className="icon-box">
            <a href="https://github.com/SamedShukurov"><i className="fa-brands fa-github"></i></a>
            <a href="https://linkedin.com/in/samed-shukurov/"><i className="fa-brands fa-linkedin"></i></a>
            <a href="https://medium.com/@semedshukurov"><i className="fa-brands fa-medium"></i></a>
          </div>
